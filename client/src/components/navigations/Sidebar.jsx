  ...
  return (
    <>
      ...
      >
        <div>
          {links.map((link, index) => (
            <NavLink
              ...
              onClick={toggleSideBar}
              className={({ isActive }) =>
                `hover:text-brand-light flex py-4 border-b ${
                  isActive ? "text-brand-base font-bold" : "text-gray-600"
                }`
              }
            >
              {link.label}
        ...
        <div className="absolute bottom-6 left-6 visible landscape:invisible">
          <button
            onClick={logout}
