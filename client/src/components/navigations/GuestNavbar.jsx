    ...
    <nav className="border-b shadow-sm shadow-brand-light sticky top-0 border-lightgreen bg-white z-20 ">
      <div className="container mx-auto px-5 md:px-10 py-2 flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <NavLink
            to="/login"
            className="w-auto px-3 py-3 sm:px-6 sm:py-3 border bg-brand-dark border-white text-white font-semibold rounded-lg hover:bg-brand-base text-sm leading-none"
          >
            Sign In
          </NavLink>
        </div>
