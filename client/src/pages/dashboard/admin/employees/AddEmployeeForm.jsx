...
const AddEmployeeForm = () => {
  ...
  const hasEmptyFields = Object.values(newEmployee).some(
    (value) => value === ""
  );
  ...
  return (
    <div className="max-w-xl mx-auto mt-8 bg-white shadow-lg rounded-base p-8 relative">
      <button
      ...
      {credentialsToShow && (
        <div className="mt-6 p-4 border border-gray-100 rounded-base text-center">
          <p>
            <strong>Email:</strong> {credentialsToShow.email}
          </p>
          <p>
            <strong>Password:</strong> {credentialsToShow.password}
          </p>
      ...
      <form onSubmit={handleAddEmployee} className="space-y-6">
        <div className="grid grid-cols-1">
          ...
          />
          {capsLockIsOn && (
            <p className="text-brand-darkest p-0 m-0 text-sm font-medium animate-pulse">
              ⚠️ Caps Lock is ON!
            </p>
          )}
        </div>
