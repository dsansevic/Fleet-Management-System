          ...
          <div className="w-full mx-auto">
            <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {vehicles.map((vehicle) => (
                <li
                  key={vehicle._id}
                  className="flex flex-col justify-between p-6 border border-gray-200 rounded-base shadow-sm bg-white hover:shadow-md transition duration-200"
                >
                  ...
                  <Link
                    to={`edit/${vehicle._id}`}
                    className="mt-4 px-4 py-2 text-brand-dark bg-purple-100 hover:bg-purple-200 rounded-base text-sm font-medium shadow-sm transition-all w-full text-center"
                  >
                    Edit
                  </Link>
                </li>
